  ...
  return (
    <div className='mb-20'>
        <div className="hero-section ">
            <div className="content grid md:grid-cols-2 grid-cols-1 md:gap-5 gap-10 justify-items-center lg:mx-36 md:mx-20 mx-8 lg:mt-32 -mt-0">
                <div className="desc">
                ...
                <img src={BgPeo} alt="" className='lg:w-[60%] md:w-[70%] w-[80%]'/>
            </div>
        </div>
    </div>
  )
